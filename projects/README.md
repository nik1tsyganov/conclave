...
The Windows-era notes for `hearth` and `signal-sim` (2026-08/09 Cursor-hosted trials) were removed on 2026-09-16; they are in git history before `main` `0761b71`. New product runs record their notes here from the macOS runtime (`tools/run-drive.js`, `tools/project-run-report.js`).
