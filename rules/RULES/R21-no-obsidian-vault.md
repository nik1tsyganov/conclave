...
| role | lead+seat |
| tag | VERIFIED |
| sources | LOCAL-BRIEF.md; ai-ops-vault Wiki Entities Plugin-Magi / Plugin-MagiCLI / Plugin-Conclave |
...
- Index lists `R21` in the pointer-sized RULES index.
- Body file path (this file) is what seats Read when the brief says `RULES/R21-no-obsidian-vault.md`.
