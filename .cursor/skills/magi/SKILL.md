...
- Every Magi CLI **implement** seat brief MUST include the `src/index.js` re-export, `PR_BODY.md`, and full fixture `BRIEF.md` MUST lines (paste `tools/templates/implement-brief-export-must.md` or equivalent). Do not abbreviate to `Implement src/X.js + PR_BODY.md`.
