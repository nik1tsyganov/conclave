...
Do not treat Synara host helpers, browser captures, or `synara-capture` hook output as CONCLAVE votes. The runner captures conversation, usage, and observed-model evidence. Acknowledge the brief's exact first line and cite sources used for synthesis.
