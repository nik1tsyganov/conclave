...
MAGI is free software under the GNU Affero General Public License, version 3, the whole text
...
preserve the attribution "MAGI by Nikita Tsyganov, https://github.com/nik1tsyganov/magi" in
...
presented as the original MAGI or as endorsed by, made by or affiliated with Nikita Tsyganov.

**(c) Names and marks (section 7(e)).** This License grants no rights to use the name "MAGI"
or any other mark used by this project, except as required to preserve the attribution above.
...
Section 13. Anyone who runs a modified MAGI as a network service must offer that modified
...
MAGI is an independent project inspired by Evangelion. It has no affiliation with, or
endorsement from, the holders of those marks.
