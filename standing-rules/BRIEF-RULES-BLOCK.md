# CONCLAVE CLI brief rules block
...
Vendor: <codex|claude|agy>; casper_via=agy for Google. hostMode: cursor-cli (or synara, claude-code, vscode, droppy). not the legacy conclave scaffold (R20).
